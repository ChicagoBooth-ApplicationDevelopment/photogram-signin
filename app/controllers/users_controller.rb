class UsersController < ApplicationController
  ...
  def authenticate
    ...
    #want to get the username from params
    #want to get the password from params
    ...
    if user == nil
      redirect_to("/user_sign_in", { :alert => "No one by that name exists" })
      ...
      if user.authenticate(pw)
        ...
        redirect_to("/user_sign_in", { :alert => "Nice try, but nope!" })
      end
    end
  end
